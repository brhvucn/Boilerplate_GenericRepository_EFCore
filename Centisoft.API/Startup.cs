...
using Centisoft.BusinessLogic.Facade;
...
namespace Centisoft.API
{
    public class Startup
    {
        ...
        {
            //add the DataContext and configure it to use Sql Server
            ...
            //Dependency Injection of facades and repositories
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Centisoft.API v1"));
            }
